...
$conn = mysqli_connect("localhost", "root", "","hospitals");
	$sele = "SELECT * FROM hospital";
	$result = mysqli_query($conn,$sele);
	if($row = mysqli_num_rows($result) > 0){
	?><table id="myTable">
<tr class="header">
<th style="width:10%;">Hospital ID</th>
...
<?php
	...
	<tr>
		...
		<td><form method="post" action="viewhospital.php">
...
if (mysqli_query($conn, $sql)) {
	?><script>
  location.assign("viewhospital.php");
</script>
<?php
